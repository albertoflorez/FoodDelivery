...
async function main() {
  ...
  console.log("Petición de generación de Pedido de 0.01 ETHER...");
  const tx1 = await producto.updateAndBuyProducto("Hamburguesa", "10000000000000000", RESTAURANTE_WALLET_ADDRESS, { value: ethers.utils.parseEther("0.01")});
  await tx1.wait();
