...
async function main() {
  ...
  await tx31.wait();
  console.log("Actualización para indicar que el pedido ha sido ANORMAL...");
  const tx32 = await pedido.resolutionPedido(0, compensacion.address);
  await tx32.wait();

  console.log("Despues de realizar el pedido, siendo un pedido ANORMAL, este es el balance en los wallets...");
